...
<head>
	...
	<title>Ticketing | MindCare</title>
	
	<link rel="stylesheet" href="ticketSubmit.css">
...
<body>
	...
	<div class="container">
		<form action="insert" method="post">
			<div class="row">
				<div class="col">
					<h3 class="title">Ticket submission Form</h3>
					<br><br>
					<div class="inputBox">
						<span>Ticket status</span>
						<input type="text" name="status" placeholder="New | Not resolved | Open" required >
					</div>
					<div class="inputBox">
						<span>Date :</span>
					...
					<div class="inputBox">
						...
						<textarea id="" rows="10" name="descripton" placeholder="Enter Your Special Request" required ></textarea>
					</div>
				</div>
			</div>

			<input type="submit" name="submit" value="Submit ticket" class="submit-btn">		
		</form>
	</div>
